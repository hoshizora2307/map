...
//
// /api/data へのリクエスト → JSONBin.io へ安全に中継(鍵はサーバー側のみ)
// それ以外のリクエスト       → public/ 内の静的ファイル(index.htmlなど)を返す
//
// JSONBIN_KEY / JSONBIN_BIN_ID は Cloudflare の
// 「Settings > Variables and Secrets」で設定してください。
// このファイルには本物の鍵は書きません。
